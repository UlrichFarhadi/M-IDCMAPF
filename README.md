...
3. Run the Visualization_of_single_run.py to see how everything looks. The parameters can be changed in the function "run_one_sim" in main() at the bottom of the .py file to increase or decrease the amount of agents or change the map to another of your liking.
